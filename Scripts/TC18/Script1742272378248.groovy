...
TestObject myTestObject = new TestObject('logoutButton').addProperty('css', ConditionType.EQUALS, '.btn.btn-default')

WebUI.waitForElementClickable(myTestObject, 30, FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.click(findTestObject('Page_CURA Healthcare Service/a_Logout_Button'))
